...
1. If you use GitHub, upload your solution to GitHub and make the repo private. Add [@scottwarren](https://github.com/scottwarren), [@tomasztunik](https://github.com/tomasztunik), and [@zofiag](https://github.com/zofiag) as collaborators ([how do I do that?](https://help.github.com/en/articles/inviting-collaborators-to-a-personal-repository)).
